...
public class FeaturesProfileRecyclerAdapter extends RecyclerView.Adapter<FeaturesProfileRecyclerAdapter.MyViewHolder> {
    ...
    public FeaturesProfileRecyclerAdapter(Context context, List<MyMatrimonyModel> myMatrimonyModelList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_features_profile, parent, false);
