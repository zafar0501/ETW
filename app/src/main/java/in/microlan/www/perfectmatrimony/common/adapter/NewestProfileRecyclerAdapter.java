...
public class NewestProfileRecyclerAdapter extends RecyclerView.Adapter<NewestProfileRecyclerAdapter.MyViewHolder> {
    ...
    public NewestProfileRecyclerAdapter(Context context, List<MyMatrimonyModel> myMatrimonyModelList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.row_newest_profile, parent, false);
